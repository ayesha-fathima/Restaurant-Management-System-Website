...
if(isset($_POST['submit']))
{
  ...
  $password=$_POST['password'];
          ...
          $qryone="SELECT * FROM `user_signup` WHERE `email_id` ='$email' AND `Create_password` = '$password'";
          ...
          header("location:restaurantpage.php?okay=$id");
          }
  ...
  <body>
    ...
    <div class="div-center card">
      <form class="" method="post">
          <div class="center">
            <img src="assets/avatar.png" alt="Avatar" class="avatar" style="margin-left: 65px;">
          </div>
          <div class="container">
              ...
              <button onclick="document.getElementById('id01').style.display='block'" style="" name="submit"   type="submit">Login</button>
          </div>
      </form>
    </div>
